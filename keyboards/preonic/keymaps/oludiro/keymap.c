...
[_LOWER] = {
  ...
  {_______, KC_PAUS, KC_MPRV, KC_MNXT, _______, KC_BSPC, KC_BSPC, _______,    KC_MPLY,    KC_VOLD, KC_VOLU, KC_MUTE}
},
...
[_RAISE] = {
  ...
  {_______, KC_PAUS, KC_MPRV, KC_MNXT, _______, KC_DEL,  KC_DEL,  _______, KC_MPLY, KC_VOLD, KC_VOLU, KC_MUTE}
},
