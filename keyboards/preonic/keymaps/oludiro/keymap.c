...
[_QWERTY] = {
  ...
  {LT(_GUI, KC_LCBR),   ALL_T(KC_RCBR), KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,             KC_RGHT}
},
...
[_GUI] = {
  ...
  {_______, KC_BTN2, KC_MS_U, KC_BTN1, KC_WH_D, _______, _______, WM_PREV, WM_NW,   WM_N,    WM_NE,   _______},
  {_______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, _______, _______, WM_FULL, WM_W,    WM_CNTR, WM_E,    _______},
  {_______, KC_WH_L, KC_BTN3, KC_WH_R, _______, _______, _______, WM_NEXT, WM_SW,   WM_S,    WM_SE,   _______},
